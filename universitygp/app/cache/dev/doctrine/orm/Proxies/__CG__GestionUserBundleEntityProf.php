...
class Prof extends \Gestion\UserBundle\Entity\Prof implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'lastLogin', 'locked', 'expired', 'expiresAt', 'confirmationToken', 'passwordRequestedAt', 'roles', 'credentialsExpired', 'credentialsExpireAt', 'id', 'new', 'cursus', 'nom', 'prenom', 'image', 'tel', 'mobile', 'cv', 'presentation', 'affectations', 'emplois');
    }
