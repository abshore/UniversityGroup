...
class ChatController extends Controller
{
	...
	$list=$em->getRepository('UserCommunicationBundle:User')->findBy(array(), array('id' => 'desc'));
        return $this->render('UserCommunicationBundle:Chat:index.html.twig', array('list' => $list));
    }
